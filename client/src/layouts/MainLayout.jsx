        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            ...
            <Link to="/" className="flex items-center gap-2 group">
              <img src={logoImg} alt="BharatBuild" className="h-16 w-auto group-hover:scale-105 transition-transform" />
            </Link>

            {/* Desktop Nav */}
            <nav className="hidden md:flex items-center gap-1">
              {[
                { label: 'Workers', category: 'workers' },
                { label: 'Machinery', category: 'machinery' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                <img src={logoImg} alt="BharatBuild" className="h-14 w-auto" />
              </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link to="/provider" className="block text-sm text-slate-400 hover:text-brand transition-colors">Dashboard</Link>
              </div>
            </div>
            <div>
